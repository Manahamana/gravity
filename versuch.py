...
namen = ['Sonne', 'Merkur', 'Venus', 'Erde', 'Moon', 'Mars', 'Jupiter',
         'Saturn', 'Uranus', 'Neptun', 'Tempel 1', '2010TK7']

# Farben für die Darstellung der Himmelskörper.
farben = ['gold', 'darkcyan', 'orange', 'blue', 'gray', 'red', 'brown',
...
m = np.array([1.3271244004e+20, 2.2031868550e+13, 3.2485859200e+14,
              3.9860043544e+14, 7.349e+22, 4.2828375214e+13, 1.2668653190e+17,
...
r0 = AE * np.array([
    ...
    [-3.5177804027e-01, +9.2488625202e-01, +1.3117664664e-04],
...
v0 = AE / tag * np.array([
    ...
    [-1.6405944264e-02, -6.0771728035e-03, 5.04134421550e-07],
